...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => PX BOT))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => PX BOT`)
})
         ...
         fetch('https://raw.githubusercontent.com/pajaar/grabbed-results/master/pajaar-2020-pantun-pakboy.txt')
            ...
            .then(body =>
            {
               ...
               conn.sendMessage(id, pantun, MessageType.text)
                : client.reply(from, 'Tuh Pantun)).then(() => console.log(`Sticker Processed for ${processTime(t, moment())} Second`))
   ...
   /*if (text.includes("#nulis"))
   {
      ...
      spawn("convert", [
         ...
         .on("exit", () =>
         {
            ...
            console.log("done")
            : aruga.reply(from, 'Itu Stickernya Anjim')).then(() => console.log(`Sticker Processed for ${processTime(t, moment())} Second`))
         })
   }
...
: aruga.reply(from, 'Pantun Tuh!')).then(() => console.log(`Sticker Processed for ${processTime(t, moment())} Second`))
         });
   }*/
